...
var menu_page_html = '<div id="header2" class="header" style="background-color:#fff;">\
			<span class="header_title" style="color:#ffac0e;">功能模块</span>\
		</div>\
		<div id="wrapper2" class="wrapper_nofooter bg_yellow">\
...
var set_main_html = '<div class="form_top"></div><ul class="menu_list01">\
    <li id="aboutus" class="more_mi01 menu_item01 menu_item01_t">\
        <span class="m01_icon m01_icon_zhici"></span><span>关于我们</span><span class="m01_right_arrow"></span>\
    </li><li id="chupdate" class="more_mi01 menu_item01">\
        <span class="m01_icon m01_icon_refresh"></span><span>版本更新</span><span class="m01_right_arrow"></span>\
    </li></ul><ul class="menu_list01"><li id="quit" class="more_mi01 menu_item01 menu_item01_t menu_item01_b">\
        <span class="m01_icon m01_icon_logout"></span><span>退出登录</span><span class="m01_right_arrow"></span>\
    </li></ul><div class="form_bottom"></div>';
