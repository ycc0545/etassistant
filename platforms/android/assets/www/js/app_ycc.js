...
function onDeviceReady()
{
	...
	var ycc_el = document.getElementById('ycchtml');
	var ycc_style = window.getComputedStyle(ycc_el, null).getPropertyValue('font-size');
	ycc_fs = parseFloat(ycc_style); 
	var cf = ycc_fs * 2;
	$('#my_toast').html('<canvas width="' + cf + '" height="' + cf + '" id="my_toast_loading" class="my_toast_loading"></canvas><div id="my_toast_text" class="my_toast_text"></div>');
	loading_gif(ycc_fs);
